...
#> cinemalya:v1.0.0/playback/tick
#
# @executed	at @s
#
# @within	cinemalya:v1.0.0/tick [ at @s ]
#
...
execute if score #found cinemalya.data matches 0 run return run function cinemalya:v1.0.0/playback/kill

execute at @a[tag=cinemalya.temp,limit=1] run function cinemalya:v1.0.0/playback/at_player
