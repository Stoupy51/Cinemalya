...
#> cinemalya:v1.0.0/playback/pop
#
# @executed	at @s
#
# @within	cinemalya:v1.0.0/playback/advance with storage cinemalya:work sel
#
# @args		i (unknown)
#
...
execute if entity @s[tag=cinemalya.particle] run function cinemalya:v1.0.0/playback/particle
$execute unless data storage cinemalya:work paths.i$(i).points[0] run function cinemalya:v1.0.0/playback/finish
