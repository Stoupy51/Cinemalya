...
execute if data storage cinemalya:work args.particle run function cinemalya:v1.0.0/travel/set_particle
...
function cinemalya:v1.0.0/travel/store_path with storage cinemalya:work sel
...
execute unless score #mode cinemalya.data matches 2 run function cinemalya:v1.0.0/travel/attach
