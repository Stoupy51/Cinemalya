...
#
# @within	cinemalya:v1.0.0/travel/frames/frame_loop
#
...
function cinemalya:v1.0.0/travel/frames/ease
...
function cinemalya:v1.0.0/travel/frames/append with storage cinemalya:work sel
