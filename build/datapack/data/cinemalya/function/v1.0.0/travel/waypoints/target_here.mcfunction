...
#> cinemalya:v1.0.0/travel/waypoints/target_here
#
# @executed	as the player,in the caller's execution context
#
# @within	cinemalya:v1.0.0/travel/from_here
#
...
function cinemalya:v1.0.0/travel/waypoints/read_anchor
function cinemalya:v1.0.0/travel/waypoints/close_anchor
function cinemalya:v1.0.0/travel/waypoints/raise_eyes
function cinemalya:v1.0.0/travel/waypoints/override_rotation
