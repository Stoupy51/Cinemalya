...
#> cinemalya:v1.0.0/travel/control/mid_point
#
# @within	cinemalya:v1.0.0/travel/control/arc
#
...
function cinemalya:v1.0.0/travel/control/side_amount
...
execute summon item_display run function cinemalya:v1.0.0/travel/control/side_offset with storage cinemalya:work forward
