...
#> cinemalya:v1.0.0/travel/attach
#
# @executed	as the cinematic entity
#
# @within	cinemalya:v1.0.0/travel/spawn
#
# @description		Bind the launching player to this cinematic and hand them over to the camera.
#

execute unless entity @s[tag=cinemalya.keep_gamemode] run function cinemalya:v1.0.0/travel/remember_gamemode
