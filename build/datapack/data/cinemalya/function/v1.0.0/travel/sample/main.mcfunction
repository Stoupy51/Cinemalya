...
#> cinemalya:v1.0.0/travel/sample/main
#
...
execute if score #curve cinemalya.data matches 0 run function cinemalya:v1.0.0/travel/sample/bezier
execute if score #curve cinemalya.data matches 1 run function cinemalya:v1.0.0/travel/sample/catmull_rom
