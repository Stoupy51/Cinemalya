...
execute unless score #mode cinemalya.data matches 2 run function cinemalya:v1.0.0/playback/stop_silent

## Build the path
function cinemalya:v1.0.0/travel/waypoints/normalize
function cinemalya:v1.0.0/travel/control/main
function cinemalya:v1.0.0/travel/sample/main
function cinemalya:v1.0.0/travel/frames/main
...
execute summon item_display run function cinemalya:v1.0.0/travel/spawn
