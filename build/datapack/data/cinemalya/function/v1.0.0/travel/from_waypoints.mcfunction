...
#
# @within	cinemalya:v1.0.0/api/launch_path {with:$(with)}
#			cinemalya:v1.0.0/intro/one_player with storage cinemalya:input wrap
#
# @args		with (unknown)
#
...
execute unless data storage cinemalya:work args.waypoints[1] unless score #mode cinemalya.data matches 2 run function cinemalya:v1.0.0/travel/waypoints/prepend_here
