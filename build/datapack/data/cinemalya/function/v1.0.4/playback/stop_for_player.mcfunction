...
#> cinemalya:v1.0.4/playback/stop_for_player
#
# @executed	as the player
#
# @within	cinemalya:v1.0.4/playback/stop
#			cinemalya:v1.0.4/playback/stop_silent
#
...
execute as @e[type=item_display,tag=cinemalya.cinematic,predicate=cinemalya:has_same_id] run function cinemalya:v1.0.4/playback/stop_one
