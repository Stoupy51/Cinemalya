...
#> cinemalya:v1.0.4/playback/kill
#
# @executed	at @s
#
# @within	cinemalya:v1.0.4/playback/tick
#			cinemalya:v1.0.4/playback/finish
...
function cinemalya:v1.0.4/playback/clear_path with storage cinemalya:work sel
kill @s
