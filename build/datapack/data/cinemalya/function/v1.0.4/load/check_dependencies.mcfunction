...
execute if score #dependency_error cinemalya.data matches 0 if score $bs.spline.major load.status matches 4 unless score $bs.spline.minor load.status matches 2.. run scoreboard players set #dependency_error cinemalya.data 1
