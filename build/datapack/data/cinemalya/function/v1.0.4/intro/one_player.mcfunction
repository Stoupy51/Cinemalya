...
#> cinemalya:v1.0.4/intro/one_player
#
# @executed	as & at one selected player
#
# @within	cinemalya:v1.0.4/intro/spread with storage cinemalya:work intro
#
...
function cinemalya:v1.0.4/travel/from_waypoints with storage cinemalya:input wrap
