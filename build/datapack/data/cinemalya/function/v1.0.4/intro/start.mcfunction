...
#> cinemalya:v1.0.4/intro/start
#
# @executed	positioned & rotated at the establishing shot the intro opens on
#
# @within	cinemalya:v1.0.4/api/intro {with:$(with)}
#
# @args		with (unknown)
#
...
## Optional arguments
execute unless data storage cinemalya:work intro.target_function run data modify storage cinemalya:work intro.target_function set value "cinemalya:v1.0.4/intro/none"
...
execute summon marker run function cinemalya:v1.0.4/travel/waypoints/read_here
...
function cinemalya:v1.0.4/intro/spread with storage cinemalya:work intro
...
execute positioned ~ ~1.6 ~ run function cinemalya:v1.0.4/intro/display with storage cinemalya:work intro
