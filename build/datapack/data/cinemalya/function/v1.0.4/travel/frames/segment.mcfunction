...
#
# @within	cinemalya:v1.0.4/travel/frames/segment_loop
#
...
function cinemalya:v1.0.4/travel/frames/read_duration with storage cinemalya:work sel
...
function cinemalya:v1.0.4/travel/frames/segment_ease
...
function cinemalya:v1.0.4/travel/frames/segment_loop
