...
#> cinemalya:v1.0.4/travel/frames/segment_ease
#
# @within	cinemalya:v1.0.4/travel/frames/segment
#
...
function cinemalya:v1.0.4/travel/frames/read_ease with storage cinemalya:work sel
