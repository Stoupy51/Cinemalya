...
#> cinemalya:v1.0.4/travel/waypoints/look_ahead
#
# @executed	in the caller's own execution context
#
# @within	cinemalya:v1.0.4/travel/waypoints/resolve_at
#			cinemalya:v1.0.4/travel/waypoints/target_here
...
execute positioned ^ ^ ^1 summon marker run function cinemalya:v1.0.4/travel/waypoints/read_ahead
