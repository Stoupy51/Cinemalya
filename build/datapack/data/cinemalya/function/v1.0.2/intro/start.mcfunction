...
#
# @within	cinemalya:v1.0.2/api/intro {with:$(with)}
#
# @args		with (unknown)
#
...
## Optional arguments
execute unless data storage cinemalya:work intro.target_function run data modify storage cinemalya:work intro.target_function set value "cinemalya:v1.0.2/intro/none"
...
function cinemalya:v1.0.2/travel/waypoints/look_ahead
execute summon marker run function cinemalya:v1.0.2/travel/waypoints/read_here
...
function cinemalya:v1.0.2/intro/spread with storage cinemalya:work intro
...
execute positioned ~ ~1.6 ~ run function cinemalya:v1.0.2/intro/display with storage cinemalya:work intro
