...
#
# @within	cinemalya:v1.0.2/api/launch_path {with:$(with)}
#			cinemalya:v1.0.2/intro/one_player with storage cinemalya:input wrap
#
# @args		with (unknown)
#
...
function cinemalya:v1.0.2/travel/defaults
execute unless data storage cinemalya:work args.waypoints[0] run return fail
execute unless data storage cinemalya:work args.waypoints[1] unless score #mode cinemalya.data matches 2 run function cinemalya:v1.0.2/travel/waypoints/prepend_here
execute unless data storage cinemalya:work args.waypoints[1] run return fail
function cinemalya:v1.0.2/travel/start
