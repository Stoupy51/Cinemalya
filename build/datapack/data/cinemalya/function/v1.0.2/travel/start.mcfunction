...
#> cinemalya:v1.0.2/travel/start
#
# @executed	as & at the player,or anywhere at all for a detached camera
#
# @within	cinemalya:v1.0.2/travel/from_coords
#			cinemalya:v1.0.2/travel/from_entity
#			cinemalya:v1.0.2/travel/from_here
#			cinemalya:v1.0.2/travel/from_waypoints
#
...
execute unless score #mode cinemalya.data matches 2 run function cinemalya:v1.0.2/playback/stop_silent

## Build the path
function cinemalya:v1.0.2/travel/waypoints/normalize
function cinemalya:v1.0.2/travel/control/main
function cinemalya:v1.0.2/travel/sample/main
function cinemalya:v1.0.2/travel/frames/main
...
execute summon item_display run function cinemalya:v1.0.2/travel/spawn
