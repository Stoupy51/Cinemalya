...
#> cinemalya:v1.0.2/travel/frames/frame
#
# @within	cinemalya:v1.0.2/travel/frames/frame_loop
#
...
function cinemalya:v1.0.2/travel/frames/ease
...
function cinemalya:v1.0.2/travel/frames/append with storage cinemalya:work sel
