...
#> cinemalya:v1.0.2/travel/waypoints/target_from_entity
#
# @within	cinemalya:v1.0.2/travel/from_entity
#
...
function cinemalya:v1.0.2/travel/waypoints/read_target with storage cinemalya:work args
