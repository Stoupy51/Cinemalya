...
#> cinemalya:v1.0.2/travel/waypoints/look_ahead
#
# @executed	in the caller's own execution context
#
# @within	cinemalya:v1.0.2/travel/waypoints/resolve_at
...
execute positioned ^ ^ ^1 summon marker run function cinemalya:v1.0.2/travel/waypoints/read_ahead
