...
#> cinemalya:v1.0.2/travel/waypoints/expand
#
# @within	cinemalya:v1.0.2/travel/waypoints/fill with storage cinemalya:work sel
#
# @args		i (unknown)
#
...
$execute if data storage cinemalya:work args.waypoints[$(i)].args[4] run function cinemalya:v1.0.2/travel/waypoints/expand_rot with storage cinemalya:work sel
