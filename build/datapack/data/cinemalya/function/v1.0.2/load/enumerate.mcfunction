...
#> cinemalya:v1.0.2/load/enumerate
#
...
execute if score #cinemalya.major load.status matches 1 if score #cinemalya.minor load.status matches 0 unless score #cinemalya.patch load.status matches 2.. run scoreboard players set #cinemalya.patch load.status 2
