...
#
# @within	cinemalya:v1.0.3/intro/spread with storage cinemalya:work intro
#
...
function cinemalya:v1.0.3/travel/from_waypoints with storage cinemalya:input wrap
