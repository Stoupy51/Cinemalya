...
#> cinemalya:v1.0.3/intro/fade_in
#
# @within	cinemalya:v1.0.3/intro/display 30t replace [ scheduled ]
#
...
schedule function cinemalya:v1.0.3/intro/playsound 10t replace
