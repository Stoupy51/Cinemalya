...
#> cinemalya:v1.0.3/intro/spread
#
# @executed	positioned & rotated at the establishing shot
#
# @within	cinemalya:v1.0.3/intro/start with storage cinemalya:work intro
#
...
$execute as $(selector) at @s run function cinemalya:v1.0.3/intro/one_player with storage cinemalya:work intro
