...
#> cinemalya:v1.0.3/travel/from_coords
#
# @executed	as & at the player
#
# @within	cinemalya:v1.0.3/api/launch {with:$(with)}
#
# @args		with (unknown)
#
...
function cinemalya:v1.0.3/travel/waypoints/start_here
function cinemalya:v1.0.3/travel/waypoints/target_from_coords
