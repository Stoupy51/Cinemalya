...
#> cinemalya:v1.0.3/travel/frames/segment
#
# @within	cinemalya:v1.0.3/travel/frames/segment_loop
#
...
function cinemalya:v1.0.3/travel/frames/read_duration with storage cinemalya:work sel
...
function cinemalya:v1.0.3/travel/frames/segment_ease

scoreboard players set #f cinemalya.data 1
function cinemalya:v1.0.3/travel/frames/frame_loop

scoreboard players add #seg cinemalya.data 1
function cinemalya:v1.0.3/travel/frames/segment_loop
