...
#> cinemalya:v1.0.3/travel/waypoints/raise_eyes
#
# @within	cinemalya:v1.0.3/travel/waypoints/target_here
#			cinemalya:v1.0.3/travel/waypoints/start_here
#			cinemalya:v1.0.3/travel/waypoints/prepend_here
#			cinemalya:v1.0.3/travel/waypoints/target_from_entity
#			cinemalya:v1.0.3/intro/start
#			cinemalya:v1.0.3/intro/one_player
#
