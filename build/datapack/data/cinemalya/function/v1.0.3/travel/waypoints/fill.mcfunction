...
#> cinemalya:v1.0.3/travel/waypoints/fill
#
# @within	cinemalya:v1.0.3/travel/waypoints/normalize_one with storage cinemalya:work sel
#
# @args		i (unknown)
#
...
$execute if data storage cinemalya:work args.waypoints[$(i)].args run function cinemalya:v1.0.3/travel/waypoints/expand with storage cinemalya:work sel
$execute if data storage cinemalya:work args.waypoints[$(i)].at run function cinemalya:v1.0.3/travel/waypoints/resolve_at with storage cinemalya:work sel
