...
#> cinemalya:v1.0.1/load/confirm_load
#
# @within	cinemalya:v1.0.1/load/valid_dependencies
#

# Confirm load
tellraw @a[tag=convention.debug] {"text":"[Loaded Cinemalya v1.0.1]","color":"green"}
scoreboard players set #cinemalya.loaded load.status 1
function cinemalya:v1.0.1/load/set_items_storage
