...
#
# @within	cinemalya:v1.0.1/intro/spread with storage cinemalya:work intro
#
...
function cinemalya:v1.0.1/travel/from_waypoints with storage cinemalya:input wrap
