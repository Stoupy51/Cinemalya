...
#> cinemalya:v1.0.1/intro/display
#
# @executed	positioned ~ ~1.6 ~
#
# @within	cinemalya:v1.0.1/intro/start with storage cinemalya:work intro [ positioned ~ ~1.6 ~ ]
#
# @args		title (unknown)
#			title_color (unknown)
#			subtitle (unknown)
...
schedule function cinemalya:v1.0.1/intro/fade_in 30t replace
$schedule function cinemalya:v1.0.1/intro/fade_out $(display_time)t replace
