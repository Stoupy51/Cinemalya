...
#> cinemalya:v1.0.1/intro/fade_in
#
# @within	cinemalya:v1.0.1/intro/display 30t replace [ scheduled ]
#
...
schedule function cinemalya:v1.0.1/intro/playsound 10t replace
