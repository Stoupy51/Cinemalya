...
#> cinemalya:v1.0.1/intro/fade_out
#
# @within	cinemalya:v1.0.1/intro/display $(display_time)t replace [ scheduled ]
#
...
schedule function cinemalya:v1.0.1/intro/cleanup 15t replace
