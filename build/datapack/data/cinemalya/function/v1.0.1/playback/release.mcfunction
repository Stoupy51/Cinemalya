...
#> cinemalya:v1.0.1/playback/release
#
# @executed	at @s
#
# @within	cinemalya:v1.0.1/playback/finish
#
...
execute at @s positioned ~ ~-1.6 ~ run function cinemalya:v1.0.1/playback/restore_gamemode
