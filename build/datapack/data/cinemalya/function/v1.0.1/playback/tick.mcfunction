...
#> cinemalya:v1.0.1/playback/tick
#
# @executed	at @s
#
# @within	cinemalya:v1.0.1/tick [ at @s ]
#
...
execute if entity @s[tag=cinemalya.precise] run function cinemalya:v1.0.1/playback/precise_rotation

# A free flying camera has nobody to carry along
execute if entity @s[tag=cinemalya.detached] run return run function cinemalya:v1.0.1/playback/advance
...
execute if score #found cinemalya.data matches 0 run return run function cinemalya:v1.0.1/playback/kill

execute at @a[tag=cinemalya.temp,limit=1] run function cinemalya:v1.0.1/playback/at_player
