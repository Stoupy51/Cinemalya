...
#> cinemalya:v1.0.1/travel/control/main
#
...
execute if score #curve cinemalya.data matches 0 run function cinemalya:v1.0.1/travel/control/arc
execute if score #curve cinemalya.data matches 1 run function cinemalya:v1.0.1/travel/control/through
