...
#> cinemalya:v1.0.1/travel/waypoints/raise_eyes
#
# @within	cinemalya:v1.0.1/travel/waypoints/target_here
#			cinemalya:v1.0.1/travel/waypoints/start_here
#			cinemalya:v1.0.1/travel/waypoints/prepend_here
#			cinemalya:v1.0.1/travel/waypoints/target_from_entity
#			cinemalya:v1.0.1/intro/read_shot
#			cinemalya:v1.0.1/intro/one_player
#
