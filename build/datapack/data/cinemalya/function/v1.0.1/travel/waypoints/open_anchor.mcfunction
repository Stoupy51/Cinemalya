...
#> cinemalya:v1.0.1/travel/waypoints/open_anchor
#
# @executed	in the caller's own execution context
#
# @within	cinemalya:v1.0.1/travel/waypoints/target_here
#			cinemalya:v1.0.1/travel/waypoints/normalize
#
...
execute positioned ^ ^ ^1 summon marker run function cinemalya:v1.0.1/travel/waypoints/anchor_ahead
execute summon marker run function cinemalya:v1.0.1/travel/waypoints/anchor_setup
