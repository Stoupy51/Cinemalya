...
#> cinemalya:v1.0.1/travel/waypoints/expand
#
...
$execute if data storage cinemalya:work args.waypoints[$(i)].args[4] run function cinemalya:v1.0.1/travel/waypoints/expand_rot with storage cinemalya:work sel
