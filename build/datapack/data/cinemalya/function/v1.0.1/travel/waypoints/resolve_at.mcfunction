...
#> cinemalya:v1.0.1/travel/waypoints/resolve_at
#
# @within	cinemalya:v1.0.1/travel/waypoints/fill with storage cinemalya:work sel
#
# @args		i (unknown)
#
...
execute as @e[type=marker,tag=cinemalya.anchor,limit=1] at @s run function cinemalya:v1.0.1/travel/waypoints/resolve_at_run with storage cinemalya:work one_at
